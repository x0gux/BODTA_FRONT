...
export function CalendarGrid({ today, date, onSelect, fullDates = [] }: CalendarGridProps) {
  return (
    <div className="lg:flex-[3] w-full grow flex flex-col min-w-0">
      ...
      <Calendar
        ...
        formatters={{
          formatWeekdayName: (d) => WEEK_DAYS_KO[d.getDay()],
        }}
        components={{
          DayButton: (props: any) => {
            ...
            return (
              ...
              >
                <div className="flex justify-between items-start w-full">
                  ...
                  {modifiers.full && (
                    <span className="font-bold text-[11px] sm:text-[13px] px-2 py-0.5 bg-white/20 rounded shadow-sm text-white uppercase tracking-wider">
                      FULL!
                    </span>
                  )}
                </div>
